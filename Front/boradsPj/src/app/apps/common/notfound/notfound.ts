    ...
    template: `
        ...
        <div class="px-8 min-h-screen flex justify-center items-center">
            <div class="z-10 text-center">
                ...
                <p class="leading-normal mt-0 mb-8 text-surface-700 dark:text-surface-100 text-xl font-medium">Esta pagina no existe</p>
                <p-button [routerLink]="['/']" severity="info" raised>Ir al Dashboard</p-button>
            </div>
        </div>
